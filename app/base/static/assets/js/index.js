/* Modified by Ajie Tri Dwantara - 2020-05-22 */
    ...
    function pageLoad(){
        nv.addGraph(function() {
            var chart = nv.models.lineChart()
                ...
                .margin({top: 0, bottom: 25, left: 60, right: 0})
                //.showLegend(false)
                .color([
                    '#59bc79', 'red'
                    ]);
            ...
            chart.yAxis
                ...
                /*.tickFormat(function(d) { return d3.time.format('%j d %H h') (new Date(d)) }); */

            chart.xAxis
                .showMaxMin(false)
                .tickFormat(function(d) { return d3.time.format('%b %d %X')(new Date(d)) }
                    );
        ...
        nv.addGraph(function() {
            ...
            chart.yAxis
                .tickFormat(function(d) {
                    ...
                    var hours = Math.floor((d- (days*86400000))/ 3600000);
            ...
            chart.y2Axis
                .tickFormat(function(d) {
                    var days= Math.floor(d/86400000);
                    var hours = Math.floor((d- (days*86400000))/ 3600000);
                    var minutes = Math.floor((d- (days*86400000)- (hours*3600000))/6000000)
                    return (days +"d "+hours+" h")
                });

            d3.select('#uptime-chart svg')
                .datum(data)
                .transition().duration(500)
                .call(chart)
                    ;
